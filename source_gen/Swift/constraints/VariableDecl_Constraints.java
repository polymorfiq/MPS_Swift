...
public class VariableDecl_Constraints extends BaseConstraintsDescriptor {
  public VariableDecl_Constraints() {
    super(CONCEPTS.VariableDecl$jP);
  }
  ...
  public static class Has_explicit_type_Property extends BasePropertyConstraintsDescriptor {
    ...
    public boolean validateValue(SNode node, Object propertyValue, CheckingNodeContext checkingNodeContext) {
      ...
      if (!(result) && checkingNodeContext != null) {
        checkingNodeContext.setBreakingNode(new SNodePointer("r:cadaf8f5-bf2c-4eea-8e82-c1c814da96ef(Swift.constraints)", "175470559280441714"));
      }
      return result;
    }
  ...
  public static class Has_initial_value_Property extends BasePropertyConstraintsDescriptor {
    ...
    public boolean validateValue(SNode node, Object propertyValue, CheckingNodeContext checkingNodeContext) {
      boolean result = staticValidateProperty(node, SPropertyOperations.castBoolean(propertyValue));
      if (!(result) && checkingNodeContext != null) {
        checkingNodeContext.setBreakingNode(new SNodePointer("r:cadaf8f5-bf2c-4eea-8e82-c1c814da96ef(Swift.constraints)", "175470559280450113"));
      }
      return result;
    }
    private static boolean staticValidateProperty(SNode node, boolean propertyValue) {
