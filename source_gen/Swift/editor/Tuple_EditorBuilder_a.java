...
/*package*/ class Tuple_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new typesListHandler_3einsy_b0(myNode, getEditorContext());
  ...
  private static class typesListHandler_3einsy_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public typesListHandler_3einsy_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(typesListHandler_3einsy_b0.this.getNode(), LINKS.types$1GrB));
      try {
