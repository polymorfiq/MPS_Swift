...
/*package*/ class ConstantDecl_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ConstantDecl_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ijn6lr_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createRefNodeList_0());
    if (nodeCondition_ijn6lr_a2a()) {
      editorCell.addEditorCell(createConstant_1());
    }
    if (nodeCondition_ijn6lr_a3a()) {
      editorCell.addEditorCell(createRefNode_0());
    }
    if (nodeCondition_ijn6lr_a4a()) {
      editorCell.addEditorCell(createConstant_2());
    }
    if (nodeCondition_ijn6lr_a5a()) {
      editorCell.addEditorCell(createRefNode_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_ijn6lr_a2a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.has_explicit_type$5hVM);
  }
  private boolean nodeCondition_ijn6lr_a3a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.has_explicit_type$5hVM);
  }
  private boolean nodeCondition_ijn6lr_a4a() {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new variablesListHandler_ijn6lr_b0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_variables");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class variablesListHandler_ijn6lr_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public variablesListHandler_ijn6lr_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SNode nodeFactory(SNode prevNode, SNode nextNode, int index) {
      ...
      SPropertyOperations.assign(newVar, PROPS.mutable$DKBG, false);
      return newVar;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(variablesListHandler_ijn6lr_b0.this.getNode(), LINKS.variables$5iCP));
      try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_ijn6lr_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new explicit_typeSingleRoleHandler_ijn6lr_d0(myNode, LINKS.explicit_type$5j6R, getEditorContext());
    return provider.createCell();
  }
  private static class explicit_typeSingleRoleHandler_ijn6lr_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public explicit_typeSingleRoleHandler_ijn6lr_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "=");
    editorCell.setCellId("Constant_ijn6lr_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new initial_valueSingleRoleHandler_ijn6lr_f0(myNode, LINKS.initial_value$5iRQ, getEditorContext());
    return provider.createCell();
  }
  private static class initial_valueSingleRoleHandler_ijn6lr_f0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public initial_valueSingleRoleHandler_ijn6lr_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
