...
/*package*/ class RangeOp_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RangeOp_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_m9pc3r_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_m9pc3r_a0(myNode, LINKS.left$lI29, getEditorContext());
    return provider.createCell();
  }
  private static class leftSingleRoleHandler_m9pc3r_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public leftSingleRoleHandler_m9pc3r_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_m9pc3r_b0");
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_m9pc3r_c0(myNode, LINKS.right$lIwb, getEditorContext());
    return provider.createCell();
  }
  private static class rightSingleRoleHandler_m9pc3r_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public rightSingleRoleHandler_m9pc3r_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
