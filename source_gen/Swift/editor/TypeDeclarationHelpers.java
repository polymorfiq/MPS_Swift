...
public class TypeDeclarationHelpers extends TransformationMenuBase {
  public TypeDeclarationHelpers() {
    super(true);
  }
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Typable", new SNodePointer("r:a1d05219-f047-4116-a4d4-ddc08f5e1a24(Swift.editor)", "175470559279009749")));
    try {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Action_m7g9qq_a0());
    }
    return result;
  }

  private class TMP_Action_m7g9qq_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    @Nullable
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      ...
      context.getEditorMenuTrace().pushTraceInfo();
      try {
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:a1d05219-f047-4116-a4d4-ddc08f5e1a24(Swift.editor)", "175470559279009769")));
