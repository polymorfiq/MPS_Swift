...
/*package*/ class ImplicitlyUnwrappedOptional_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ImplicitlyUnwrappedOptional_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_goer6x_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ofTypeSingleRoleHandler_goer6x_a0(myNode, LINKS.ofType$2Isc, getEditorContext());
    return provider.createCell();
  }
  private static class ofTypeSingleRoleHandler_goer6x_a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ofTypeSingleRoleHandler_goer6x_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_goer6x_b0");
